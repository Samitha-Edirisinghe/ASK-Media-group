...
<html class="no-js" lang="en">
    <head>
        ...
        <title>DAN TV Network || DanTV – Ask Media Pvt Ltd</title>
                                ...
                                <nav>
                                    ...
                                    <div id="mobile-menu" class="navbar-wrap d-none d-lg-flex">
                                        <ul>
                                            ...
                                            <li class="show"><a href="javascript:void(0)">ACTIVITIES</a>
                                                <ul class="submenu">
                    ...
                    <div class="row">
                            ...
                            <div class="game-single-content game-overview-content">
                                <div class="upcoming-game-head">
                                    <div class="uc-game-head-title">
                                        <h4>DURING   <span>PANDEMIC</span></h4>
                                    </div>
                                </div>
                                <p>We facilitated FREE Online Classes for  Students by Kalai TV via Digital Media  Platform.</p>
                                <p>DAN Kalvi TV is helping individuals reach their goals  and pursue their dream. Improving lives through  learning.Kalvi TV is a channel broadcasting educational  content produced by Ask Media.The courses are covering Sri Lankan academic  programmes from grade 5 to grade 12 with  preparation for O/L and A/L exams.Kalvi TV produced more than 1,000 videos and made  them available FREE via digital platforms.Since February 2020, almost 20,000 children and  teenagers have subscribed to our channel and are  showing a growing interest in our content.</p>
                        ...
                        <div class="col-12">
                            <div class="game-single-content game-overview-content">
                                <div class="upcoming-game-head">
                                    <div class="uc-game-head-title">
                                        <h4>DAN TV <span>FOOTBALL  TOURNAMENT</span></h4>
                                    </div>
                                </div>
                                <p>DAN TV collaborating with the  Jaffna football federation  organizes an annual football  tournament. Fifty clubs from five  divisions will be participating in  this tournament.</p>
                        ...
                        <div class="col-12">
                            <div class="game-single-content game-overview-content">
                                <div class="upcoming-game-head">
                                    <div class="uc-game-head-title">
                                        <h4>NALLUR <span>FESTIVAL</span></h4>
                                    </div>
                                </div>
                                <p>Dan TV is the only Tamil channel  that broadcasts 25 days of the  prestigious and spiritual event live  via OHM TV, to the entire country as  well as the whole world.</p>
                        ...
                        <div class="col-12">
                            <div class="game-single-content game-overview-content">
                                <div class="upcoming-game-head">
                                    <div class="uc-game-head-title">
                                        <h4>DAN 31st <span>Night </span></h4>
                                    </div>
                                </div>
                                <p>Every year-end, DAN TV celebrates  New Year’s Eve extravagantly, with a  local musical band and firework  display.</p>
                        ...
                        <div class="col-12">
                            <div class="game-single-content game-overview-content">
                                <div class="upcoming-game-head">
                                    <div class="uc-game-head-title">
                                        <h4>YEAR-END <span>PROGRAMS </span></h4>
                                    </div>
                                </div>
                                <p>Every year-end, DAN TV celebrates  New Year’s Eve extravagantly, with a  local musical band and firework  display.</p>
                        ...
                        <div class="col-12">
                            <div class="game-single-content game-overview-content">
                                <div class="upcoming-game-head">
                                    <div class="uc-game-head-title">
                                        <h4>END USER <span>VISITING  </span></h4>
                                    </div>
                                </div>
                                <p>We organize BTL activations to generate opportunities  among the untapped market.</p>
